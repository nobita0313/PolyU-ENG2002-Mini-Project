...
namespace Calendar {
	...
	private:
		...
		static const Int32 bgEvent_High = 0xFFAC87E4;
...
****************************************************/
		...
		//In: Hour(hr), Min(min)
		//Out: Year(y)
		void getPosFromTime(int * y, int hr, int min){
			int weeklyCalCHeight = weekly_cal->RowStyles[0]->Height + 1;
			*y = weeklyCalCHeight * ((hr * 2 + min * 2 / 60) ) - 1;
		}
...
****************************************************/
		...
		void showEvents(TableLayoutPanel^ table, int r, int c){
			if(!String::IsNullOrEmpty(userName)){
				int eventNum =5; //Number of event on that day **EDIT HERE***
				int y = 0;
				...
				if(table->Name->StartsWith("monthly_cal")){
					...
					for(int i=0; i<eventNum; i++){
						...
						String^ text = "event_" + r + "_" + c + "_" + i; //Start time + Name of event[i]
						Int32 color = tNormal; //Color in ARGB for priority
						//Eventdata end
				...
				if(table->Name->StartsWith("weekly_cal") || table->Name->StartsWith("daily_cal")){
					...
					for(int i=0; i<eventNum; i++){
						...
						//Eventdata start **EDIT HERE***
						String^ text = "event_" + c + "_" + i; //Start time + Name of event[i]
						Int32 color = bgEvent_Nor; //Color in ARGB for priority
						getPosFromTime(&y, 3+i, 30); //get start position, input start hr, min
						getPosFromTime(&height, 0, 30); //get height , input duration hr, min
						//Eventdata end
		...
		void drawMonthlyCal(TableLayoutPanel^ table){
			...
			for(int i=(lastMonth->GetMaxDay() - thisMonthDate[0].GetXY('x') - rowCorrection * 7); i<lastMonth->GetMaxDay(); i++){
				...
				showEvents(table, 1, lastMonthDate[i].GetXY('x'));
			}
			...
			for(int i=0; i<thisMonth->GetMaxDay(); i++){
				...
				showEvents(table, thisMonthDate[i].GetXY('y') + rowCorrection, thisMonthDate[i].GetXY('x'));
			}	
			...
			for(int i=0; i<dayToShow; i++){
				...
				showEvents(table, nextMonthDate[i].GetXY('y') - 1 + rowCorrection, nextMonthDate[i].GetXY('x'));
			}
			this->ResumeLayout();
		}
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->monthly_cal->ColumnStyles->Add((gcnew System::Windows::Forms::ColumnStyle(System::Windows::Forms::SizeType::Absolute, 120)));
			this->monthly_cal->ColumnStyles->Add((gcnew System::Windows::Forms::ColumnStyle(System::Windows::Forms::SizeType::Absolute, 120)));
			this->monthly_cal->ColumnStyles->Add((gcnew System::Windows::Forms::ColumnStyle(System::Windows::Forms::SizeType::Absolute, 120)));
			this->monthly_cal->ColumnStyles->Add((gcnew System::Windows::Forms::ColumnStyle(System::Windows::Forms::SizeType::Absolute, 120)));
			this->monthly_cal->ColumnStyles->Add((gcnew System::Windows::Forms::ColumnStyle(System::Windows::Forms::SizeType::Absolute, 120)));
			this->monthly_cal->ColumnStyles->Add((gcnew System::Windows::Forms::ColumnStyle(System::Windows::Forms::SizeType::Absolute, 120)));
			this->monthly_cal->ColumnStyles->Add((gcnew System::Windows::Forms::ColumnStyle(System::Windows::Forms::SizeType::Absolute, 123)));
			...
			this->monthly_cal->Location = System::Drawing::Point(39, 0);
			this->monthly_cal->Margin = System::Windows::Forms::Padding(0);
			this->monthly_cal->Name = L"monthly_cal";
			this->monthly_cal->RowCount = 7;
			this->monthly_cal->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Absolute, 26)));
			this->monthly_cal->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Absolute, 90)));
			this->monthly_cal->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Absolute, 90)));
			this->monthly_cal->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Absolute, 90)));
			this->monthly_cal->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Absolute, 90)));
			this->monthly_cal->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Absolute, 90)));
			this->monthly_cal->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Absolute, 90)));
			this->monthly_cal->Size = System::Drawing::Size(851, 574);
			...
			this->mPanel_6_6->Location = System::Drawing::Point(727, 483);
			this->mPanel_6_6->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_6_6->Name = L"mPanel_6_6";
			this->mPanel_6_6->Size = System::Drawing::Size(123, 90);
			...
			this->mDay_6_6->Location = System::Drawing::Point(2, 3);
			this->mDay_6_6->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_6_6->Name = L"mDay_6_6";
			this->mDay_6_6->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_6_5->Location = System::Drawing::Point(606, 483);
			this->mPanel_6_5->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_6_5->Name = L"mPanel_6_5";
			this->mPanel_6_5->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_6_5->Location = System::Drawing::Point(2, 3);
			this->mDay_6_5->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_6_5->Name = L"mDay_6_5";
			this->mDay_6_5->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_6_4->Location = System::Drawing::Point(485, 483);
			this->mPanel_6_4->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_6_4->Name = L"mPanel_6_4";
			this->mPanel_6_4->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_6_4->Location = System::Drawing::Point(2, 3);
			this->mDay_6_4->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_6_4->Name = L"mDay_6_4";
			this->mDay_6_4->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_6_3->Location = System::Drawing::Point(364, 483);
			this->mPanel_6_3->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_6_3->Name = L"mPanel_6_3";
			this->mPanel_6_3->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_6_3->Location = System::Drawing::Point(2, 3);
			this->mDay_6_3->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_6_3->Name = L"mDay_6_3";
			this->mDay_6_3->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_6_2->Location = System::Drawing::Point(243, 483);
			this->mPanel_6_2->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_6_2->Name = L"mPanel_6_2";
			this->mPanel_6_2->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_6_2->Location = System::Drawing::Point(2, 3);
			this->mDay_6_2->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_6_2->Name = L"mDay_6_2";
			this->mDay_6_2->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_6_1->Location = System::Drawing::Point(122, 483);
			this->mPanel_6_1->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_6_1->Name = L"mPanel_6_1";
			this->mPanel_6_1->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_6_1->Location = System::Drawing::Point(2, 3);
			this->mDay_6_1->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_6_1->Name = L"mDay_6_1";
			this->mDay_6_1->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_6_0->Location = System::Drawing::Point(1, 483);
			this->mPanel_6_0->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_6_0->Name = L"mPanel_6_0";
			this->mPanel_6_0->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_6_0->Location = System::Drawing::Point(2, 3);
			this->mDay_6_0->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_6_0->Name = L"mDay_6_0";
			this->mDay_6_0->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_5_6->Location = System::Drawing::Point(727, 392);
			this->mPanel_5_6->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_5_6->Name = L"mPanel_5_6";
			this->mPanel_5_6->Size = System::Drawing::Size(123, 90);
			...
			this->mDay_5_6->Location = System::Drawing::Point(2, 3);
			this->mDay_5_6->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_5_6->Name = L"mDay_5_6";
			this->mDay_5_6->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_5_5->Location = System::Drawing::Point(606, 392);
			this->mPanel_5_5->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_5_5->Name = L"mPanel_5_5";
			this->mPanel_5_5->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_5_5->Location = System::Drawing::Point(2, 3);
			this->mDay_5_5->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_5_5->Name = L"mDay_5_5";
			this->mDay_5_5->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_5_4->Location = System::Drawing::Point(485, 392);
			this->mPanel_5_4->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_5_4->Name = L"mPanel_5_4";
			this->mPanel_5_4->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_5_4->Location = System::Drawing::Point(2, 3);
			this->mDay_5_4->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_5_4->Name = L"mDay_5_4";
			this->mDay_5_4->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_5_3->Location = System::Drawing::Point(364, 392);
			this->mPanel_5_3->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_5_3->Name = L"mPanel_5_3";
			this->mPanel_5_3->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_5_3->Location = System::Drawing::Point(2, 3);
			this->mDay_5_3->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_5_3->Name = L"mDay_5_3";
			this->mDay_5_3->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_5_2->Location = System::Drawing::Point(243, 392);
			this->mPanel_5_2->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_5_2->Name = L"mPanel_5_2";
			this->mPanel_5_2->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_5_2->Location = System::Drawing::Point(2, 3);
			this->mDay_5_2->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_5_2->Name = L"mDay_5_2";
			this->mDay_5_2->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_5_1->Location = System::Drawing::Point(122, 392);
			this->mPanel_5_1->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_5_1->Name = L"mPanel_5_1";
			this->mPanel_5_1->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_5_1->Location = System::Drawing::Point(2, 3);
			this->mDay_5_1->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_5_1->Name = L"mDay_5_1";
			this->mDay_5_1->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_5_0->Location = System::Drawing::Point(1, 392);
			this->mPanel_5_0->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_5_0->Name = L"mPanel_5_0";
			this->mPanel_5_0->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_5_0->Location = System::Drawing::Point(2, 3);
			this->mDay_5_0->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_5_0->Name = L"mDay_5_0";
			this->mDay_5_0->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_4_6->Location = System::Drawing::Point(727, 301);
			this->mPanel_4_6->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_4_6->Name = L"mPanel_4_6";
			this->mPanel_4_6->Size = System::Drawing::Size(123, 90);
			...
			this->mDay_4_6->Location = System::Drawing::Point(2, 3);
			this->mDay_4_6->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_4_6->Name = L"mDay_4_6";
			this->mDay_4_6->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_4_5->Location = System::Drawing::Point(606, 301);
			this->mPanel_4_5->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_4_5->Name = L"mPanel_4_5";
			this->mPanel_4_5->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_4_5->Location = System::Drawing::Point(2, 3);
			this->mDay_4_5->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_4_5->Name = L"mDay_4_5";
			this->mDay_4_5->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_4_4->Location = System::Drawing::Point(485, 301);
			this->mPanel_4_4->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_4_4->Name = L"mPanel_4_4";
			this->mPanel_4_4->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_4_4->Location = System::Drawing::Point(2, 3);
			this->mDay_4_4->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_4_4->Name = L"mDay_4_4";
			this->mDay_4_4->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_4_3->Location = System::Drawing::Point(364, 301);
			this->mPanel_4_3->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_4_3->Name = L"mPanel_4_3";
			this->mPanel_4_3->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_4_3->Location = System::Drawing::Point(2, 3);
			this->mDay_4_3->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_4_3->Name = L"mDay_4_3";
			this->mDay_4_3->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_4_2->Location = System::Drawing::Point(243, 301);
			this->mPanel_4_2->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_4_2->Name = L"mPanel_4_2";
			this->mPanel_4_2->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_4_2->Location = System::Drawing::Point(2, 3);
			this->mDay_4_2->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_4_2->Name = L"mDay_4_2";
			this->mDay_4_2->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_4_1->Location = System::Drawing::Point(122, 301);
			this->mPanel_4_1->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_4_1->Name = L"mPanel_4_1";
			this->mPanel_4_1->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_4_1->Location = System::Drawing::Point(2, 3);
			this->mDay_4_1->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_4_1->Name = L"mDay_4_1";
			this->mDay_4_1->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_4_0->Location = System::Drawing::Point(1, 301);
			this->mPanel_4_0->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_4_0->Name = L"mPanel_4_0";
			this->mPanel_4_0->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_4_0->Location = System::Drawing::Point(2, 3);
			this->mDay_4_0->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_4_0->Name = L"mDay_4_0";
			this->mDay_4_0->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_3_6->Location = System::Drawing::Point(727, 210);
			this->mPanel_3_6->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_3_6->Name = L"mPanel_3_6";
			this->mPanel_3_6->Size = System::Drawing::Size(123, 90);
			...
			this->mDay_3_6->Location = System::Drawing::Point(2, 3);
			this->mDay_3_6->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_3_6->Name = L"mDay_3_6";
			this->mDay_3_6->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_3_5->Location = System::Drawing::Point(606, 210);
			this->mPanel_3_5->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_3_5->Name = L"mPanel_3_5";
			this->mPanel_3_5->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_3_5->Location = System::Drawing::Point(2, 3);
			this->mDay_3_5->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_3_5->Name = L"mDay_3_5";
			this->mDay_3_5->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_3_4->Location = System::Drawing::Point(485, 210);
			this->mPanel_3_4->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_3_4->Name = L"mPanel_3_4";
			this->mPanel_3_4->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_3_4->Location = System::Drawing::Point(2, 3);
			this->mDay_3_4->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_3_4->Name = L"mDay_3_4";
			this->mDay_3_4->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_3_3->Location = System::Drawing::Point(364, 210);
			this->mPanel_3_3->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_3_3->Name = L"mPanel_3_3";
			this->mPanel_3_3->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_3_3->Location = System::Drawing::Point(2, 3);
			this->mDay_3_3->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_3_3->Name = L"mDay_3_3";
			this->mDay_3_3->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_3_2->Location = System::Drawing::Point(243, 210);
			this->mPanel_3_2->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_3_2->Name = L"mPanel_3_2";
			this->mPanel_3_2->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_3_2->Location = System::Drawing::Point(2, 3);
			this->mDay_3_2->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_3_2->Name = L"mDay_3_2";
			this->mDay_3_2->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_3_1->Location = System::Drawing::Point(122, 210);
			this->mPanel_3_1->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_3_1->Name = L"mPanel_3_1";
			this->mPanel_3_1->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_3_1->Location = System::Drawing::Point(2, 3);
			this->mDay_3_1->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_3_1->Name = L"mDay_3_1";
			this->mDay_3_1->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_2_6->Location = System::Drawing::Point(727, 119);
			this->mPanel_2_6->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_2_6->Name = L"mPanel_2_6";
			this->mPanel_2_6->Size = System::Drawing::Size(123, 90);
			...
			this->mDay_2_6->Location = System::Drawing::Point(2, 3);
			this->mDay_2_6->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_2_6->Name = L"mDay_2_6";
			this->mDay_2_6->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_2_5->Location = System::Drawing::Point(606, 119);
			this->mPanel_2_5->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_2_5->Name = L"mPanel_2_5";
			this->mPanel_2_5->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_2_5->Location = System::Drawing::Point(2, 3);
			this->mDay_2_5->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_2_5->Name = L"mDay_2_5";
			this->mDay_2_5->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_2_4->Location = System::Drawing::Point(485, 119);
			this->mPanel_2_4->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_2_4->Name = L"mPanel_2_4";
			this->mPanel_2_4->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_2_4->Location = System::Drawing::Point(2, 3);
			this->mDay_2_4->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_2_4->Name = L"mDay_2_4";
			this->mDay_2_4->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_2_3->Location = System::Drawing::Point(364, 119);
			this->mPanel_2_3->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_2_3->Name = L"mPanel_2_3";
			this->mPanel_2_3->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_2_3->Location = System::Drawing::Point(2, 3);
			this->mDay_2_3->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_2_3->Name = L"mDay_2_3";
			this->mDay_2_3->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_2_2->Location = System::Drawing::Point(243, 119);
			this->mPanel_2_2->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_2_2->Name = L"mPanel_2_2";
			this->mPanel_2_2->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_2_2->Location = System::Drawing::Point(2, 3);
			this->mDay_2_2->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_2_2->Name = L"mDay_2_2";
			this->mDay_2_2->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_2_1->Location = System::Drawing::Point(122, 119);
			this->mPanel_2_1->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_2_1->Name = L"mPanel_2_1";
			this->mPanel_2_1->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_2_1->Location = System::Drawing::Point(2, 3);
			this->mDay_2_1->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_2_1->Name = L"mDay_2_1";
			this->mDay_2_1->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_1_6->Location = System::Drawing::Point(727, 28);
			this->mPanel_1_6->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_1_6->Name = L"mPanel_1_6";
			this->mPanel_1_6->Size = System::Drawing::Size(123, 90);
			...
			this->mDay_1_6->Location = System::Drawing::Point(2, 3);
			this->mDay_1_6->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_1_6->Name = L"mDay_1_6";
			this->mDay_1_6->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_1_5->Location = System::Drawing::Point(606, 28);
			this->mPanel_1_5->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_1_5->Name = L"mPanel_1_5";
			this->mPanel_1_5->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_1_5->Location = System::Drawing::Point(2, 3);
			this->mDay_1_5->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_1_5->Name = L"mDay_1_5";
			this->mDay_1_5->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_1_4->Location = System::Drawing::Point(485, 28);
			this->mPanel_1_4->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_1_4->Name = L"mPanel_1_4";
			this->mPanel_1_4->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_1_4->Location = System::Drawing::Point(2, 3);
			this->mDay_1_4->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_1_4->Name = L"mDay_1_4";
			this->mDay_1_4->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_1_3->Location = System::Drawing::Point(364, 28);
			this->mPanel_1_3->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_1_3->Name = L"mPanel_1_3";
			this->mPanel_1_3->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_1_3->Location = System::Drawing::Point(2, 3);
			this->mDay_1_3->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_1_3->Name = L"mDay_1_3";
			this->mDay_1_3->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_1_2->Location = System::Drawing::Point(243, 28);
			this->mPanel_1_2->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_1_2->Name = L"mPanel_1_2";
			this->mPanel_1_2->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_1_2->Location = System::Drawing::Point(2, 3);
			this->mDay_1_2->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_1_2->Name = L"mDay_1_2";
			this->mDay_1_2->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_1_1->Location = System::Drawing::Point(122, 28);
			this->mPanel_1_1->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_1_1->Name = L"mPanel_1_1";
			this->mPanel_1_1->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_1_1->Location = System::Drawing::Point(2, 3);
			this->mDay_1_1->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_1_1->Name = L"mDay_1_1";
			this->mDay_1_1->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_0_6->Location = System::Drawing::Point(727, 1);
			this->mPanel_0_6->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_0_6->Name = L"mPanel_0_6";
			this->mPanel_0_6->Size = System::Drawing::Size(123, 26);
			this->mPanel_0_6->TabIndex = 55;
			// 
			// mWDay_6
			// 
			this->mWDay_6->AutoSize = true;
			this->mWDay_6->Location = System::Drawing::Point(2, 6);
			this->mWDay_6->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->mWDay_6->Name = L"mWDay_6";
			this->mWDay_6->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_0_5->Location = System::Drawing::Point(606, 1);
			this->mPanel_0_5->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_0_5->Name = L"mPanel_0_5";
			this->mPanel_0_5->Size = System::Drawing::Size(120, 26);
			this->mPanel_0_5->TabIndex = 54;
			// 
			// mWDay_5
			// 
			this->mWDay_5->AutoSize = true;
			this->mWDay_5->Location = System::Drawing::Point(2, 6);
			this->mWDay_5->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->mWDay_5->Name = L"mWDay_5";
			this->mWDay_5->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_0_4->Location = System::Drawing::Point(485, 1);
			this->mPanel_0_4->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_0_4->Name = L"mPanel_0_4";
			this->mPanel_0_4->Size = System::Drawing::Size(120, 26);
			this->mPanel_0_4->TabIndex = 53;
			// 
			// mWDay_4
			// 
			this->mWDay_4->AutoSize = true;
			this->mWDay_4->Location = System::Drawing::Point(2, 6);
			this->mWDay_4->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->mWDay_4->Name = L"mWDay_4";
			this->mWDay_4->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_0_3->Location = System::Drawing::Point(364, 1);
			this->mPanel_0_3->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_0_3->Name = L"mPanel_0_3";
			this->mPanel_0_3->Size = System::Drawing::Size(120, 26);
			this->mPanel_0_3->TabIndex = 52;
			// 
			// mWDay_3
			// 
			this->mWDay_3->AutoSize = true;
			this->mWDay_3->Location = System::Drawing::Point(2, 6);
			this->mWDay_3->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->mWDay_3->Name = L"mWDay_3";
			this->mWDay_3->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_0_2->Location = System::Drawing::Point(243, 1);
			this->mPanel_0_2->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_0_2->Name = L"mPanel_0_2";
			this->mPanel_0_2->Size = System::Drawing::Size(120, 26);
			this->mPanel_0_2->TabIndex = 51;
			// 
			// mWDay_2
			// 
			this->mWDay_2->AutoSize = true;
			this->mWDay_2->Location = System::Drawing::Point(2, 6);
			this->mWDay_2->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->mWDay_2->Name = L"mWDay_2";
			this->mWDay_2->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_0_1->Location = System::Drawing::Point(122, 1);
			this->mPanel_0_1->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_0_1->Name = L"mPanel_0_1";
			this->mPanel_0_1->Size = System::Drawing::Size(120, 26);
			this->mPanel_0_1->TabIndex = 50;
			// 
			// mWDay_1
			// 
			this->mWDay_1->AutoSize = true;
			this->mWDay_1->Location = System::Drawing::Point(2, 6);
			this->mWDay_1->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->mWDay_1->Name = L"mWDay_1";
			this->mWDay_1->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_0_0->Size = System::Drawing::Size(120, 26);
			...
			this->mWDay_0->Items->AddRange(gcnew cli::array< System::Object^  >(7) {L"Sunday", L"Monday", L"Tuesday", L"Wednesday", L"Thursday", 
				L"Friday", L"Saturday"});
			this->mWDay_0->Location = System::Drawing::Point(1, 3);
			this->mWDay_0->Name = L"mWDay_0";
			this->mWDay_0->Size = System::Drawing::Size(116, 21);
			...
			this->mPanel_1_0->Location = System::Drawing::Point(1, 28);
			this->mPanel_1_0->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_1_0->Name = L"mPanel_1_0";
			this->mPanel_1_0->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_1_0->Location = System::Drawing::Point(2, 3);
			this->mDay_1_0->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_1_0->Name = L"mDay_1_0";
			this->mDay_1_0->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_2_0->Location = System::Drawing::Point(1, 119);
			this->mPanel_2_0->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_2_0->Name = L"mPanel_2_0";
			this->mPanel_2_0->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_2_0->Location = System::Drawing::Point(2, 3);
			this->mDay_2_0->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_2_0->Name = L"mDay_2_0";
			this->mDay_2_0->Size = System::Drawing::Size(35, 13);
			...
			this->mPanel_3_0->Location = System::Drawing::Point(1, 210);
			this->mPanel_3_0->Margin = System::Windows::Forms::Padding(0);
			this->mPanel_3_0->Name = L"mPanel_3_0";
			this->mPanel_3_0->Size = System::Drawing::Size(120, 90);
			...
			this->mDay_3_0->Location = System::Drawing::Point(2, 3);
			this->mDay_3_0->Margin = System::Windows::Forms::Padding(2, 2, 2, 0);
			this->mDay_3_0->Name = L"mDay_3_0";
			this->mDay_3_0->Size = System::Drawing::Size(35, 13);
			...
			this->display_year->Location = System::Drawing::Point(226, 4);
			...
			this->display_year->Size = System::Drawing::Size(49, 29);
			...
			this->display_month->Font = (gcnew System::Drawing::Font(L"Segoe UI", 16.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->display_month->Location = System::Drawing::Point(110, 4);
			...
			this->display_month->Size = System::Drawing::Size(112, 29);
			...
			// prev_btn
			// 
			this->prev_btn->Location = System::Drawing::Point(1, 0);
			this->prev_btn->Margin = System::Windows::Forms::Padding(1, 0, 1, 0);
			this->prev_btn->Name = L"prev_btn";
			this->prev_btn->Size = System::Drawing::Size(25, 23);
			...
			// next_btn
			// 
			this->next_btn->Location = System::Drawing::Point(81, 0);
			this->next_btn->Margin = System::Windows::Forms::Padding(1, 0, 1, 0);
			this->next_btn->Name = L"next_btn";
			this->next_btn->Size = System::Drawing::Size(25, 23);
			...
			// monthly_type
			// 
			this->monthly_type->Location = System::Drawing::Point(1, 0);
			this->monthly_type->Margin = System::Windows::Forms::Padding(1, 0, 1, 0);
			this->monthly_type->Name = L"monthly_type";
			this->monthly_type->Size = System::Drawing::Size(75, 23);
			...
			// weekly_type
			// 
			this->weekly_type->Location = System::Drawing::Point(78, 0);
			this->weekly_type->Margin = System::Windows::Forms::Padding(1, 0, 1, 0);
			this->weekly_type->Name = L"weekly_type";
			this->weekly_type->Size = System::Drawing::Size(75, 23);
			...
			// daily_type
			// 
			this->daily_type->Location = System::Drawing::Point(155, 0);
			this->daily_type->Margin = System::Windows::Forms::Padding(1, 0, 1, 0);
			this->daily_type->Name = L"daily_type";
			this->daily_type->Size = System::Drawing::Size(75, 23);
			...
			// now_btn
			// 
			this->now_btn->Location = System::Drawing::Point(28, 0);
			this->now_btn->Margin = System::Windows::Forms::Padding(1, 0, 1, 0);
			this->now_btn->Name = L"now_btn";
			this->now_btn->Size = System::Drawing::Size(51, 23);
			...
			this->mPanel->Location = System::Drawing::Point(0, 57);
			this->mPanel->Margin = System::Windows::Forms::Padding(2);
			this->mPanel->Name = L"mPanel";
			this->mPanel->Size = System::Drawing::Size(926, 574);
			...
			this->wPanel->Location = System::Drawing::Point(0, 57);
			this->wPanel->Margin = System::Windows::Forms::Padding(0);
			this->wPanel->Name = L"wPanel";
			this->wPanel->Size = System::Drawing::Size(926, 574);
			this->wPanel->TabIndex = 14;
			// 
			// wBtmLine
			// 
			this->wBtmLine->Location = System::Drawing::Point(0, 0);
			this->wBtmLine->Margin = System::Windows::Forms::Padding(2);
			this->wBtmLine->Name = L"wBtmLine";
			this->wBtmLine->Size = System::Drawing::Size(1, 1);
			this->wBtmLine->TabIndex = 1;
			// 
			// wTopLine
			// 
			this->wTopLine->Location = System::Drawing::Point(0, 0);
			this->wTopLine->Margin = System::Windows::Forms::Padding(2);
			this->wTopLine->Name = L"wTopLine";
			this->wTopLine->Size = System::Drawing::Size(1, 1);
			...
			this->wPanel_head->Location = System::Drawing::Point(92, 0);
			this->wPanel_head->Margin = System::Windows::Forms::Padding(0);
			this->wPanel_head->Name = L"wPanel_head";
			this->wPanel_head->Size = System::Drawing::Size(792, 28);
			...
			this->weekly_cal_title->Size = System::Drawing::Size(792, 28);
			...
			this->wPanel_0_1->Size = System::Drawing::Size(112, 26);
			this->wPanel_0_1->TabIndex = 49;
			// 
			// wWDay_0_1
			// 
			this->wWDay_0_1->AutoSize = true;
			this->wWDay_0_1->Location = System::Drawing::Point(2, 6);
			this->wWDay_0_1->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->wWDay_0_1->Name = L"wWDay_0_1";
			this->wWDay_0_1->Size = System::Drawing::Size(35, 13);
			...
			this->wPanel_0_2->Location = System::Drawing::Point(114, 1);
			this->wPanel_0_2->Margin = System::Windows::Forms::Padding(0);
			this->wPanel_0_2->Name = L"wPanel_0_2";
			this->wPanel_0_2->Size = System::Drawing::Size(112, 26);
			this->wPanel_0_2->TabIndex = 50;
			// 
			// wWDay_0_2
			// 
			this->wWDay_0_2->AutoSize = true;
			this->wWDay_0_2->Location = System::Drawing::Point(2, 6);
			this->wWDay_0_2->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->wWDay_0_2->Name = L"wWDay_0_2";
			this->wWDay_0_2->Size = System::Drawing::Size(35, 13);
			...
			this->wPanel_0_3->Location = System::Drawing::Point(227, 1);
			this->wPanel_0_3->Margin = System::Windows::Forms::Padding(0);
			this->wPanel_0_3->Name = L"wPanel_0_3";
			this->wPanel_0_3->Size = System::Drawing::Size(112, 26);
			this->wPanel_0_3->TabIndex = 51;
			// 
			// wWDay_0_3
			// 
			this->wWDay_0_3->AutoSize = true;
			this->wWDay_0_3->Location = System::Drawing::Point(2, 6);
			this->wWDay_0_3->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->wWDay_0_3->Name = L"wWDay_0_3";
			this->wWDay_0_3->Size = System::Drawing::Size(35, 13);
			...
			this->wPanel_0_4->Location = System::Drawing::Point(340, 1);
			this->wPanel_0_4->Margin = System::Windows::Forms::Padding(0);
			this->wPanel_0_4->Name = L"wPanel_0_4";
			this->wPanel_0_4->Size = System::Drawing::Size(112, 26);
			this->wPanel_0_4->TabIndex = 52;
			// 
			// wWDay_0_4
			// 
			this->wWDay_0_4->AutoSize = true;
			this->wWDay_0_4->Location = System::Drawing::Point(2, 6);
			this->wWDay_0_4->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->wWDay_0_4->Name = L"wWDay_0_4";
			this->wWDay_0_4->Size = System::Drawing::Size(35, 13);
			...
			this->wPanel_0_5->Location = System::Drawing::Point(453, 1);
			this->wPanel_0_5->Margin = System::Windows::Forms::Padding(0);
			this->wPanel_0_5->Name = L"wPanel_0_5";
			this->wPanel_0_5->Size = System::Drawing::Size(112, 26);
			this->wPanel_0_5->TabIndex = 53;
			// 
			// wWDay_0_5
			// 
			this->wWDay_0_5->AutoSize = true;
			this->wWDay_0_5->Location = System::Drawing::Point(2, 6);
			this->wWDay_0_5->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->wWDay_0_5->Name = L"wWDay_0_5";
			this->wWDay_0_5->Size = System::Drawing::Size(35, 13);
			...
			this->wPanel_0_6->Location = System::Drawing::Point(566, 1);
			this->wPanel_0_6->Margin = System::Windows::Forms::Padding(0);
			this->wPanel_0_6->Name = L"wPanel_0_6";
			this->wPanel_0_6->Size = System::Drawing::Size(112, 26);
			this->wPanel_0_6->TabIndex = 54;
			// 
			// wWDay_0_6
			// 
			this->wWDay_0_6->AutoSize = true;
			this->wWDay_0_6->Location = System::Drawing::Point(2, 6);
			this->wWDay_0_6->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->wWDay_0_6->Name = L"wWDay_0_6";
			this->wWDay_0_6->Size = System::Drawing::Size(35, 13);
			...
			this->wPanel_0_7->Location = System::Drawing::Point(679, 1);
			this->wPanel_0_7->Margin = System::Windows::Forms::Padding(0);
			this->wPanel_0_7->Name = L"wPanel_0_7";
			this->wPanel_0_7->Size = System::Drawing::Size(112, 26);
			this->wPanel_0_7->TabIndex = 55;
			// 
			// wWDay_0_7
			// 
			this->wWDay_0_7->AutoSize = true;
			this->wWDay_0_7->Location = System::Drawing::Point(2, 6);
			this->wWDay_0_7->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->wWDay_0_7->Name = L"wWDay_0_7";
			this->wWDay_0_7->Size = System::Drawing::Size(35, 13);
			...
			this->wPanel_body->Location = System::Drawing::Point(39, 27);
			this->wPanel_body->Margin = System::Windows::Forms::Padding(0);
			this->wPanel_body->Name = L"wPanel_body";
			this->wPanel_body->Size = System::Drawing::Size(862, 545);
			...
			this->weekly_cal->ColumnStyles->Add((gcnew System::Windows::Forms::ColumnStyle(System::Windows::Forms::SizeType::Absolute, 52)));
			this->weekly_cal->ColumnStyles->Add((gcnew System::Windows::Forms::ColumnStyle(System::Windows::Forms::SizeType::Absolute, 112)));
			this->weekly_cal->ColumnStyles->Add((gcnew System::Windows::Forms::ColumnStyle(System::Windows::Forms::SizeType::Absolute, 112)));
			this->weekly_cal->ColumnStyles->Add((gcnew System::Windows::Forms::ColumnStyle(System::Windows::Forms::SizeType::Absolute, 112)));
			this->weekly_cal->ColumnStyles->Add((gcnew System::Windows::Forms::ColumnStyle(System::Windows::Forms::SizeType::Absolute, 112)));
			this->weekly_cal->ColumnStyles->Add((gcnew System::Windows::Forms::ColumnStyle(System::Windows::Forms::SizeType::Absolute, 112)));
			this->weekly_cal->ColumnStyles->Add((gcnew System::Windows::Forms::ColumnStyle(System::Windows::Forms::SizeType::Absolute, 112)));
			this->weekly_cal->ColumnStyles->Add((gcnew System::Windows::Forms::ColumnStyle(System::Windows::Forms::SizeType::Absolute, 113)));
			...
			this->weekly_cal->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Absolute, 23)));
			this->weekly_cal->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Absolute, 23)));
			this->weekly_cal->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Absolute, 23)));
			this->weekly_cal->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Absolute, 23)));
			this->weekly_cal->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Absolute, 23)));
			...
			this->weekly_cal->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Absolute, 23)));
			this->weekly_cal->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Absolute, 23)));
			this->weekly_cal->Size = System::Drawing::Size(846, 1153);
			...
			this->wPanel_1_7->Location = System::Drawing::Point(732, 1);
			...
			this->wPanel_1_7->Size = System::Drawing::Size(113, 1151);
			...
			this->wPanel_1_6->Location = System::Drawing::Point(619, 1);
			...
			this->wPanel_1_6->Size = System::Drawing::Size(112, 1151);
			...
			this->wPanel_1_5->Location = System::Drawing::Point(506, 1);
			...
			this->wPanel_1_5->Size = System::Drawing::Size(112, 1151);
			...
			this->wPanel_1_4->Location = System::Drawing::Point(393, 1);
			...
			this->wPanel_1_4->Size = System::Drawing::Size(112, 1151);
			...
			this->wPanel_1_3->Location = System::Drawing::Point(280, 1);
			...
			this->wPanel_1_3->Size = System::Drawing::Size(112, 1151);
			...
			this->wPanel_1_2->Location = System::Drawing::Point(167, 1);
			...
			this->wPanel_1_2->Size = System::Drawing::Size(112, 1151);
			...
			this->wPanel_18_0->Location = System::Drawing::Point(1, 817);
			...
			this->wPanel_18_0->Size = System::Drawing::Size(52, 47);
			...
			this->wHr_18_0->Location = System::Drawing::Point(18, 3);
			this->wHr_18_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->wHr_18_0->Name = L"wHr_18_0";
			this->wHr_18_0->Size = System::Drawing::Size(34, 13);
			...
			this->wPanel_17_0->Location = System::Drawing::Point(1, 769);
			...
			this->wPanel_17_0->Size = System::Drawing::Size(52, 47);
			...
			this->wHr_17_0->Location = System::Drawing::Point(18, 3);
			this->wHr_17_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->wHr_17_0->Name = L"wHr_17_0";
			this->wHr_17_0->Size = System::Drawing::Size(34, 13);
			...
			this->wPanel_16_0->Location = System::Drawing::Point(1, 721);
			...
			this->wPanel_16_0->Size = System::Drawing::Size(52, 47);
			...
			this->wHr_16_0->Location = System::Drawing::Point(18, 3);
			this->wHr_16_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->wHr_16_0->Name = L"wHr_16_0";
			this->wHr_16_0->Size = System::Drawing::Size(34, 13);
			...
			this->wPanel_15_0->Location = System::Drawing::Point(1, 673);
			...
			this->wPanel_15_0->Size = System::Drawing::Size(52, 47);
			...
			this->wHr_15_0->Location = System::Drawing::Point(18, 3);
			this->wHr_15_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->wHr_15_0->Name = L"wHr_15_0";
			this->wHr_15_0->Size = System::Drawing::Size(34, 13);
			...
			this->wPanel_14_0->Location = System::Drawing::Point(1, 625);
			...
			this->wPanel_14_0->Size = System::Drawing::Size(52, 47);
			...
			this->wHr_14_0->Location = System::Drawing::Point(18, 3);
			this->wHr_14_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->wHr_14_0->Name = L"wHr_14_0";
			this->wHr_14_0->Size = System::Drawing::Size(34, 13);
			...
			this->wPanel_13_0->Location = System::Drawing::Point(1, 577);
			...
			this->wPanel_13_0->Size = System::Drawing::Size(52, 47);
			...
			this->wHr_13_0->Location = System::Drawing::Point(18, 3);
			this->wHr_13_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->wHr_13_0->Name = L"wHr_13_0";
			this->wHr_13_0->Size = System::Drawing::Size(34, 13);
			...
			this->wPanel_12_0->Location = System::Drawing::Point(1, 529);
			...
			this->wPanel_12_0->Size = System::Drawing::Size(52, 47);
			...
			this->wHr_12_0->Location = System::Drawing::Point(18, 3);
			this->wHr_12_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->wHr_12_0->Name = L"wHr_12_0";
			this->wHr_12_0->Size = System::Drawing::Size(34, 13);
			...
			this->wPanel_11_0->Location = System::Drawing::Point(1, 481);
			...
			this->wPanel_11_0->Size = System::Drawing::Size(52, 47);
			...
			this->wHr_11_0->Location = System::Drawing::Point(18, 3);
			this->wHr_11_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->wHr_11_0->Name = L"wHr_11_0";
			this->wHr_11_0->Size = System::Drawing::Size(34, 13);
			...
			this->wPanel_10_0->Location = System::Drawing::Point(1, 433);
			...
			this->wPanel_10_0->Size = System::Drawing::Size(52, 47);
			...
			this->wHr_10_0->Location = System::Drawing::Point(18, 3);
			this->wHr_10_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->wHr_10_0->Name = L"wHr_10_0";
			this->wHr_10_0->Size = System::Drawing::Size(34, 13);
			...
			this->wPanel_9_0->Location = System::Drawing::Point(1, 385);
			...
			this->wPanel_9_0->Size = System::Drawing::Size(52, 47);
			...
			this->wHr_9_0->Location = System::Drawing::Point(18, 3);
			this->wHr_9_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->wHr_9_0->Name = L"wHr_9_0";
			this->wHr_9_0->Size = System::Drawing::Size(34, 13);
			...
			this->wPanel_8_0->Location = System::Drawing::Point(1, 337);
			...
			this->wPanel_8_0->Size = System::Drawing::Size(52, 47);
			...
			this->wHr_8_0->Location = System::Drawing::Point(18, 3);
			this->wHr_8_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->wHr_8_0->Name = L"wHr_8_0";
			this->wHr_8_0->Size = System::Drawing::Size(34, 13);
			...
			this->wPanel_7_0->Location = System::Drawing::Point(1, 289);
			...
			this->wPanel_7_0->Size = System::Drawing::Size(52, 47);
			...
			this->wHr_7_0->Location = System::Drawing::Point(18, 3);
			this->wHr_7_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->wHr_7_0->Name = L"wHr_7_0";
			this->wHr_7_0->Size = System::Drawing::Size(34, 13);
			...
			this->wPanel_6_0->Location = System::Drawing::Point(1, 241);
			...
			this->wPanel_6_0->Size = System::Drawing::Size(52, 47);
			...
			this->wHr_6_0->Location = System::Drawing::Point(18, 3);
			this->wHr_6_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->wHr_6_0->Name = L"wHr_6_0";
			this->wHr_6_0->Size = System::Drawing::Size(34, 13);
			...
			this->wPanel_4_0->Location = System::Drawing::Point(1, 145);
			...
			this->wPanel_4_0->Size = System::Drawing::Size(52, 47);
			...
			this->wHr_4_0->Location = System::Drawing::Point(18, 3);
			this->wHr_4_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->wHr_4_0->Name = L"wHr_4_0";
			this->wHr_4_0->Size = System::Drawing::Size(34, 13);
			...
			this->wPanel_2_0->Location = System::Drawing::Point(1, 49);
			...
			this->wPanel_2_0->Size = System::Drawing::Size(52, 47);
			...
			this->wHr_2_0->Location = System::Drawing::Point(18, 3);
			this->wHr_2_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->wHr_2_0->Name = L"wHr_2_0";
			this->wHr_2_0->Size = System::Drawing::Size(34, 13);
			...
			this->wPanel_3_0->Location = System::Drawing::Point(1, 97);
			...
			this->wPanel_3_0->Size = System::Drawing::Size(52, 47);
			...
			this->wHr_3_0->Location = System::Drawing::Point(18, 3);
			this->wHr_3_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->wHr_3_0->Name = L"wHr_3_0";
			this->wHr_3_0->Size = System::Drawing::Size(34, 13);
			...
			this->wPanel_5_0->Location = System::Drawing::Point(1, 193);
			...
			this->wPanel_5_0->Size = System::Drawing::Size(52, 47);
			...
			this->wHr_5_0->Location = System::Drawing::Point(18, 3);
			this->wHr_5_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->wHr_5_0->Name = L"wHr_5_0";
			this->wHr_5_0->Size = System::Drawing::Size(34, 13);
			...
			this->wPanel_24_0->Location = System::Drawing::Point(1, 1105);
			...
			this->wPanel_24_0->Size = System::Drawing::Size(52, 47);
			...
			this->wHr_24_0->Location = System::Drawing::Point(18, 3);
			this->wHr_24_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->wHr_24_0->Name = L"wHr_24_0";
			this->wHr_24_0->Size = System::Drawing::Size(34, 13);
			...
			this->wPanel_23_0->Location = System::Drawing::Point(1, 1057);
			...
			this->wPanel_23_0->Size = System::Drawing::Size(52, 47);
			...
			this->wHr_23_0->Location = System::Drawing::Point(18, 3);
			this->wHr_23_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->wHr_23_0->Name = L"wHr_23_0";
			this->wHr_23_0->Size = System::Drawing::Size(34, 13);
			...
			this->wPanel_22_0->Location = System::Drawing::Point(1, 1009);
			...
			this->wPanel_22_0->Size = System::Drawing::Size(52, 47);
			...
			this->wHr_22_0->Location = System::Drawing::Point(18, 3);
			this->wHr_22_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->wHr_22_0->Name = L"wHr_22_0";
			this->wHr_22_0->Size = System::Drawing::Size(34, 13);
			...
			this->wPanel_21_0->Location = System::Drawing::Point(1, 961);
			...
			this->wPanel_21_0->Size = System::Drawing::Size(52, 47);
			...
			this->wHr_21_0->Location = System::Drawing::Point(18, 3);
			this->wHr_21_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->wHr_21_0->Name = L"wHr_21_0";
			this->wHr_21_0->Size = System::Drawing::Size(34, 13);
			...
			this->wPanel_20_0->Location = System::Drawing::Point(1, 913);
			...
			this->wPanel_20_0->Size = System::Drawing::Size(52, 47);
			...
			this->wHr_20_0->Location = System::Drawing::Point(18, 3);
			this->wHr_20_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->wHr_20_0->Name = L"wHr_20_0";
			this->wHr_20_0->Size = System::Drawing::Size(34, 13);
			...
			this->wPanel_19_0->Location = System::Drawing::Point(1, 865);
			...
			this->wPanel_19_0->Size = System::Drawing::Size(52, 47);
			...
			this->wHr_19_0->Location = System::Drawing::Point(18, 3);
			this->wHr_19_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->wHr_19_0->Name = L"wHr_19_0";
			this->wHr_19_0->Size = System::Drawing::Size(34, 13);
			...
			this->wPanel_1_0->Size = System::Drawing::Size(52, 47);
			...
			this->wHr_1_0->Location = System::Drawing::Point(18, 3);
			this->wHr_1_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->wHr_1_0->Name = L"wHr_1_0";
			this->wHr_1_0->Size = System::Drawing::Size(34, 13);
			...
			this->wPanel_1_1->Location = System::Drawing::Point(54, 1);
			...
			this->wPanel_1_1->Size = System::Drawing::Size(112, 1151);
			...
			this->dPanel->Location = System::Drawing::Point(0, 57);
			this->dPanel->Margin = System::Windows::Forms::Padding(2);
			this->dPanel->Name = L"dPanel";
			this->dPanel->Size = System::Drawing::Size(926, 574);
			...
			this->daily_monthly_cal->Location = System::Drawing::Point(39, 219);
			...
			this->daily_monthly_cal->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Absolute, 28)));
			this->daily_monthly_cal->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Absolute, 45)));
			this->daily_monthly_cal->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Absolute, 45)));
			this->daily_monthly_cal->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Absolute, 45)));
			this->daily_monthly_cal->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Absolute, 45)));
			this->daily_monthly_cal->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Absolute, 45)));
			this->daily_monthly_cal->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Absolute, 45)));
			this->daily_monthly_cal->Size = System::Drawing::Size(389, 306);
			...
			this->dMPanel_6_2->Location = System::Drawing::Point(111, 260);
			this->dMPanel_6_2->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_6_2->Name = L"dMPanel_6_2";
			this->dMPanel_6_2->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_6_2->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_6_1->Location = System::Drawing::Point(56, 260);
			this->dMPanel_6_1->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_6_1->Name = L"dMPanel_6_1";
			this->dMPanel_6_1->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_6_1->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_6_0->Location = System::Drawing::Point(1, 260);
			this->dMPanel_6_0->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_6_0->Name = L"dMPanel_6_0";
			this->dMPanel_6_0->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_6_0->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_6_3->Location = System::Drawing::Point(166, 260);
			this->dMPanel_6_3->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_6_3->Name = L"dMPanel_6_3";
			this->dMPanel_6_3->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_6_3->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_6_6->Location = System::Drawing::Point(331, 260);
			this->dMPanel_6_6->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_6_6->Name = L"dMPanel_6_6";
			this->dMPanel_6_6->Size = System::Drawing::Size(57, 45);
			...
			this->dDay_6_6->Size = System::Drawing::Size(57, 45);
			...
			this->dMPanel_6_5->Location = System::Drawing::Point(276, 260);
			this->dMPanel_6_5->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_6_5->Name = L"dMPanel_6_5";
			this->dMPanel_6_5->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_6_5->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_6_4->Location = System::Drawing::Point(221, 260);
			this->dMPanel_6_4->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_6_4->Name = L"dMPanel_6_4";
			this->dMPanel_6_4->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_6_4->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_5_6->Location = System::Drawing::Point(331, 214);
			this->dMPanel_5_6->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_5_6->Name = L"dMPanel_5_6";
			this->dMPanel_5_6->Size = System::Drawing::Size(57, 45);
			...
			this->dDay_5_6->Size = System::Drawing::Size(57, 45);
			...
			this->dMPanel_5_5->Location = System::Drawing::Point(276, 214);
			this->dMPanel_5_5->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_5_5->Name = L"dMPanel_5_5";
			this->dMPanel_5_5->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_5_5->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_5_4->Location = System::Drawing::Point(221, 214);
			this->dMPanel_5_4->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_5_4->Name = L"dMPanel_5_4";
			this->dMPanel_5_4->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_5_4->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_5_3->Location = System::Drawing::Point(166, 214);
			this->dMPanel_5_3->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_5_3->Name = L"dMPanel_5_3";
			this->dMPanel_5_3->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_5_3->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_5_2->Location = System::Drawing::Point(111, 214);
			this->dMPanel_5_2->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_5_2->Name = L"dMPanel_5_2";
			this->dMPanel_5_2->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_5_2->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_5_1->Location = System::Drawing::Point(56, 214);
			this->dMPanel_5_1->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_5_1->Name = L"dMPanel_5_1";
			this->dMPanel_5_1->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_5_1->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_5_0->Location = System::Drawing::Point(1, 214);
			this->dMPanel_5_0->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_5_0->Name = L"dMPanel_5_0";
			this->dMPanel_5_0->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_5_0->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_4_6->Location = System::Drawing::Point(331, 168);
			this->dMPanel_4_6->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_4_6->Name = L"dMPanel_4_6";
			this->dMPanel_4_6->Size = System::Drawing::Size(57, 45);
			...
			this->dDay_4_6->Size = System::Drawing::Size(57, 45);
			...
			this->dMPanel_4_5->Location = System::Drawing::Point(276, 168);
			this->dMPanel_4_5->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_4_5->Name = L"dMPanel_4_5";
			this->dMPanel_4_5->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_4_5->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_4_4->Location = System::Drawing::Point(221, 168);
			this->dMPanel_4_4->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_4_4->Name = L"dMPanel_4_4";
			this->dMPanel_4_4->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_4_4->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_4_3->Location = System::Drawing::Point(166, 168);
			this->dMPanel_4_3->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_4_3->Name = L"dMPanel_4_3";
			this->dMPanel_4_3->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_4_3->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_4_2->Location = System::Drawing::Point(111, 168);
			this->dMPanel_4_2->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_4_2->Name = L"dMPanel_4_2";
			this->dMPanel_4_2->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_4_2->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_4_1->Location = System::Drawing::Point(56, 168);
			this->dMPanel_4_1->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_4_1->Name = L"dMPanel_4_1";
			this->dMPanel_4_1->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_4_1->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_4_0->Location = System::Drawing::Point(1, 168);
			this->dMPanel_4_0->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_4_0->Name = L"dMPanel_4_0";
			this->dMPanel_4_0->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_4_0->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_3_6->Location = System::Drawing::Point(331, 122);
			this->dMPanel_3_6->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_3_6->Name = L"dMPanel_3_6";
			this->dMPanel_3_6->Size = System::Drawing::Size(57, 45);
			...
			this->dDay_3_6->Size = System::Drawing::Size(57, 45);
			...
			this->dMPanel_3_5->Location = System::Drawing::Point(276, 122);
			this->dMPanel_3_5->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_3_5->Name = L"dMPanel_3_5";
			this->dMPanel_3_5->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_3_5->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_3_4->Location = System::Drawing::Point(221, 122);
			this->dMPanel_3_4->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_3_4->Name = L"dMPanel_3_4";
			this->dMPanel_3_4->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_3_4->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_3_3->Location = System::Drawing::Point(166, 122);
			this->dMPanel_3_3->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_3_3->Name = L"dMPanel_3_3";
			this->dMPanel_3_3->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_3_3->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_3_2->Location = System::Drawing::Point(111, 122);
			this->dMPanel_3_2->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_3_2->Name = L"dMPanel_3_2";
			this->dMPanel_3_2->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_3_2->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_3_1->Location = System::Drawing::Point(56, 122);
			this->dMPanel_3_1->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_3_1->Name = L"dMPanel_3_1";
			this->dMPanel_3_1->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_3_1->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_3_0->Location = System::Drawing::Point(1, 122);
			this->dMPanel_3_0->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_3_0->Name = L"dMPanel_3_0";
			this->dMPanel_3_0->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_3_0->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_2_6->Location = System::Drawing::Point(331, 76);
			this->dMPanel_2_6->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_2_6->Name = L"dMPanel_2_6";
			this->dMPanel_2_6->Size = System::Drawing::Size(57, 45);
			...
			this->dDay_2_6->Size = System::Drawing::Size(57, 45);
			...
			this->dMPanel_2_5->Location = System::Drawing::Point(276, 76);
			this->dMPanel_2_5->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_2_5->Name = L"dMPanel_2_5";
			this->dMPanel_2_5->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_2_5->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_2_4->Location = System::Drawing::Point(221, 76);
			this->dMPanel_2_4->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_2_4->Name = L"dMPanel_2_4";
			this->dMPanel_2_4->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_2_4->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_2_3->Location = System::Drawing::Point(166, 76);
			this->dMPanel_2_3->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_2_3->Name = L"dMPanel_2_3";
			this->dMPanel_2_3->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_2_3->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_2_2->Location = System::Drawing::Point(111, 76);
			this->dMPanel_2_2->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_2_2->Name = L"dMPanel_2_2";
			this->dMPanel_2_2->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_2_2->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_2_1->Location = System::Drawing::Point(56, 76);
			this->dMPanel_2_1->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_2_1->Name = L"dMPanel_2_1";
			this->dMPanel_2_1->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_2_1->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_2_0->Location = System::Drawing::Point(1, 76);
			this->dMPanel_2_0->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_2_0->Name = L"dMPanel_2_0";
			this->dMPanel_2_0->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_2_0->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_1_6->Location = System::Drawing::Point(331, 30);
			this->dMPanel_1_6->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_1_6->Name = L"dMPanel_1_6";
			this->dMPanel_1_6->Size = System::Drawing::Size(57, 45);
			...
			this->dDay_1_6->Size = System::Drawing::Size(57, 45);
			...
			this->dMPanel_1_5->Location = System::Drawing::Point(276, 30);
			this->dMPanel_1_5->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_1_5->Name = L"dMPanel_1_5";
			this->dMPanel_1_5->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_1_5->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_1_4->Location = System::Drawing::Point(221, 30);
			this->dMPanel_1_4->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_1_4->Name = L"dMPanel_1_4";
			this->dMPanel_1_4->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_1_4->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_1_3->Location = System::Drawing::Point(166, 30);
			this->dMPanel_1_3->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_1_3->Name = L"dMPanel_1_3";
			this->dMPanel_1_3->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_1_3->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_1_2->Location = System::Drawing::Point(111, 30);
			this->dMPanel_1_2->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_1_2->Name = L"dMPanel_1_2";
			this->dMPanel_1_2->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_1_2->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_1_1->Location = System::Drawing::Point(56, 30);
			this->dMPanel_1_1->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_1_1->Name = L"dMPanel_1_1";
			this->dMPanel_1_1->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_1_1->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_1_0->Location = System::Drawing::Point(1, 30);
			this->dMPanel_1_0->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_1_0->Name = L"dMPanel_1_0";
			this->dMPanel_1_0->Size = System::Drawing::Size(54, 45);
			...
			this->dDay_1_0->Size = System::Drawing::Size(54, 45);
			...
			this->dMPanel_0_6->Location = System::Drawing::Point(331, 1);
			this->dMPanel_0_6->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_0_6->Name = L"dMPanel_0_6";
			this->dMPanel_0_6->Size = System::Drawing::Size(57, 28);
			...
			this->dWDay_6->Size = System::Drawing::Size(57, 28);
			...
			this->dMPanel_0_5->Location = System::Drawing::Point(276, 1);
			this->dMPanel_0_5->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_0_5->Name = L"dMPanel_0_5";
			this->dMPanel_0_5->Size = System::Drawing::Size(54, 28);
			...
			this->dWDay_5->Size = System::Drawing::Size(54, 28);
			...
			this->dMPanel_0_4->Location = System::Drawing::Point(221, 1);
			this->dMPanel_0_4->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_0_4->Name = L"dMPanel_0_4";
			this->dMPanel_0_4->Size = System::Drawing::Size(54, 28);
			...
			this->dWDay_4->Size = System::Drawing::Size(54, 28);
			...
			this->dMPanel_0_3->Location = System::Drawing::Point(166, 1);
			this->dMPanel_0_3->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_0_3->Name = L"dMPanel_0_3";
			this->dMPanel_0_3->Size = System::Drawing::Size(54, 28);
			...
			this->dWDay_3->Size = System::Drawing::Size(54, 28);
			...
			this->dMPanel_0_2->Location = System::Drawing::Point(111, 1);
			this->dMPanel_0_2->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_0_2->Name = L"dMPanel_0_2";
			this->dMPanel_0_2->Size = System::Drawing::Size(54, 28);
			...
			this->dWDay_2->Size = System::Drawing::Size(54, 28);
			...
			this->dMPanel_0_1->Location = System::Drawing::Point(56, 1);
			this->dMPanel_0_1->Margin = System::Windows::Forms::Padding(0);
			this->dMPanel_0_1->Name = L"dMPanel_0_1";
			this->dMPanel_0_1->Size = System::Drawing::Size(54, 28);
			...
			this->dWDay_1->Size = System::Drawing::Size(54, 28);
			...
			this->dMPanel_0_0->Size = System::Drawing::Size(54, 28);
			...
			this->dWDay_0->Size = System::Drawing::Size(54, 28);
			...
			this->dWDay->Font = (gcnew System::Drawing::Font(L"Segoe UI Light", 36, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->dWDay->Location = System::Drawing::Point(202, 148);
			this->dWDay->Margin = System::Windows::Forms::Padding(0);
			this->dWDay->Name = L"dWDay";
			this->dWDay->Size = System::Drawing::Size(204, 65);
			...
			this->dDay->Location = System::Drawing::Point(11, 73);
			this->dDay->Margin = System::Windows::Forms::Padding(0);
			this->dDay->Name = L"dDay";
			this->dDay->Size = System::Drawing::Size(218, 159);
			...
			this->dBtmLine->Margin = System::Windows::Forms::Padding(2);
			...
			this->dTopLine->Margin = System::Windows::Forms::Padding(2);
			...
			this->dPanel_body->Location = System::Drawing::Point(463, 0);
			this->dPanel_body->Margin = System::Windows::Forms::Padding(0);
			this->dPanel_body->Name = L"dPanel_body";
			this->dPanel_body->Size = System::Drawing::Size(440, 572);
			...
			this->daily_cal->ColumnStyles->Add((gcnew System::Windows::Forms::ColumnStyle(System::Windows::Forms::SizeType::Absolute, 52)));
			this->daily_cal->ColumnStyles->Add((gcnew System::Windows::Forms::ColumnStyle(System::Windows::Forms::SizeType::Absolute, 370)));
			...
			this->daily_cal->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Absolute, 23)));
			this->daily_cal->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Absolute, 23)));
			this->daily_cal->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Absolute, 23)));
			this->daily_cal->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Absolute, 23)));
			this->daily_cal->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Absolute, 23)));
			...
			this->daily_cal->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Absolute, 23)));
			this->daily_cal->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Absolute, 23)));
			this->daily_cal->Size = System::Drawing::Size(425, 1153);
			...
			this->dPanel_17_0->Location = System::Drawing::Point(1, 817);
			...
			this->dPanel_17_0->Size = System::Drawing::Size(52, 47);
			...
			this->dHr_17_0->Location = System::Drawing::Point(18, 3);
			this->dHr_17_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->dHr_17_0->Name = L"dHr_17_0";
			this->dHr_17_0->Size = System::Drawing::Size(34, 13);
			...
			this->dPanel_16_0->Location = System::Drawing::Point(1, 769);
			...
			this->dPanel_16_0->Size = System::Drawing::Size(52, 47);
			...
			this->dHr_16_0->Location = System::Drawing::Point(18, 3);
			this->dHr_16_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->dHr_16_0->Name = L"dHr_16_0";
			this->dHr_16_0->Size = System::Drawing::Size(34, 13);
			...
			this->dPanel_15_0->Location = System::Drawing::Point(1, 721);
			...
			this->dPanel_15_0->Size = System::Drawing::Size(52, 47);
			...
			this->dHr_15_0->Location = System::Drawing::Point(18, 3);
			this->dHr_15_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->dHr_15_0->Name = L"dHr_15_0";
			this->dHr_15_0->Size = System::Drawing::Size(34, 13);
			...
			this->dPanel_14_0->Location = System::Drawing::Point(1, 673);
			...
			this->dPanel_14_0->Size = System::Drawing::Size(52, 47);
			...
			this->dHr_14_0->Location = System::Drawing::Point(18, 3);
			this->dHr_14_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->dHr_14_0->Name = L"dHr_14_0";
			this->dHr_14_0->Size = System::Drawing::Size(34, 13);
			...
			this->dPanel_13_0->Location = System::Drawing::Point(1, 625);
			...
			this->dPanel_13_0->Size = System::Drawing::Size(52, 47);
			...
			this->dHr_13_0->Location = System::Drawing::Point(18, 3);
			this->dHr_13_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->dHr_13_0->Name = L"dHr_13_0";
			this->dHr_13_0->Size = System::Drawing::Size(34, 13);
			...
			this->dPanel_12_0->Location = System::Drawing::Point(1, 577);
			...
			this->dPanel_12_0->Size = System::Drawing::Size(52, 47);
			...
			this->dHr_12_0->Location = System::Drawing::Point(18, 3);
			this->dHr_12_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->dHr_12_0->Name = L"dHr_12_0";
			this->dHr_12_0->Size = System::Drawing::Size(34, 13);
			...
			this->dPanel_11_0->Location = System::Drawing::Point(1, 529);
			...
			this->dPanel_11_0->Size = System::Drawing::Size(52, 47);
			...
			this->dHr_11_0->Location = System::Drawing::Point(18, 3);
			this->dHr_11_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->dHr_11_0->Name = L"dHr_11_0";
			this->dHr_11_0->Size = System::Drawing::Size(34, 13);
			...
			this->dPanel_10_0->Location = System::Drawing::Point(1, 481);
			...
			this->dPanel_10_0->Size = System::Drawing::Size(52, 47);
			...
			this->dHr_10_0->Location = System::Drawing::Point(18, 3);
			this->dHr_10_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->dHr_10_0->Name = L"dHr_10_0";
			this->dHr_10_0->Size = System::Drawing::Size(34, 13);
			...
			this->dPanel_9_0->Location = System::Drawing::Point(1, 433);
			...
			this->dPanel_9_0->Size = System::Drawing::Size(52, 47);
			...
			this->dHr_9_0->Location = System::Drawing::Point(18, 3);
			this->dHr_9_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->dHr_9_0->Name = L"dHr_9_0";
			this->dHr_9_0->Size = System::Drawing::Size(34, 13);
			...
			this->dPanel_8_0->Location = System::Drawing::Point(1, 385);
			...
			this->dPanel_8_0->Size = System::Drawing::Size(52, 47);
			...
			this->dHr_8_0->Location = System::Drawing::Point(18, 3);
			this->dHr_8_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->dHr_8_0->Name = L"dHr_8_0";
			this->dHr_8_0->Size = System::Drawing::Size(34, 13);
			...
			this->dPanel_7_0->Location = System::Drawing::Point(1, 337);
			...
			this->dPanel_7_0->Size = System::Drawing::Size(52, 47);
			...
			this->dHr_7_0->Location = System::Drawing::Point(18, 3);
			this->dHr_7_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->dHr_7_0->Name = L"dHr_7_0";
			this->dHr_7_0->Size = System::Drawing::Size(34, 13);
			...
			this->dPanel_6_0->Location = System::Drawing::Point(1, 289);
			...
			this->dPanel_6_0->Size = System::Drawing::Size(52, 47);
			...
			this->dHr_6_0->Location = System::Drawing::Point(18, 3);
			this->dHr_6_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->dHr_6_0->Name = L"dHr_6_0";
			this->dHr_6_0->Size = System::Drawing::Size(34, 13);
			...
			this->dPanel_5_0->Location = System::Drawing::Point(1, 241);
			...
			this->dPanel_5_0->Size = System::Drawing::Size(52, 47);
			...
			this->dHr_5_0->Location = System::Drawing::Point(18, 3);
			this->dHr_5_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->dHr_5_0->Name = L"dHr_5_0";
			this->dHr_5_0->Size = System::Drawing::Size(34, 13);
			...
			this->dPanel_3_0->Location = System::Drawing::Point(1, 145);
			...
			this->dPanel_3_0->Size = System::Drawing::Size(52, 47);
			...
			this->dHr_3_0->Location = System::Drawing::Point(18, 3);
			this->dHr_3_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->dHr_3_0->Name = L"dHr_3_0";
			this->dHr_3_0->Size = System::Drawing::Size(34, 13);
			...
			this->dPanel_1_0->Location = System::Drawing::Point(1, 49);
			...
			this->dPanel_1_0->Size = System::Drawing::Size(52, 47);
			...
			this->dHr_1_0->Location = System::Drawing::Point(18, 3);
			this->dHr_1_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->dHr_1_0->Name = L"dHr_1_0";
			this->dHr_1_0->Size = System::Drawing::Size(34, 13);
			...
			this->dPanel_2_0->Location = System::Drawing::Point(1, 97);
			...
			this->dPanel_2_0->Size = System::Drawing::Size(52, 47);
			...
			this->dHr_2_0->Location = System::Drawing::Point(18, 3);
			this->dHr_2_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->dHr_2_0->Name = L"dHr_2_0";
			this->dHr_2_0->Size = System::Drawing::Size(34, 13);
			...
			this->dPanel_4_0->Location = System::Drawing::Point(1, 193);
			...
			this->dPanel_4_0->Size = System::Drawing::Size(52, 47);
			...
			this->dHr_4_0->Location = System::Drawing::Point(18, 3);
			this->dHr_4_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->dHr_4_0->Name = L"dHr_4_0";
			this->dHr_4_0->Size = System::Drawing::Size(34, 13);
			...
			this->dPanel_23_0->Location = System::Drawing::Point(1, 1105);
			...
			this->dPanel_23_0->Size = System::Drawing::Size(52, 47);
			...
			this->dHr_23_0->Location = System::Drawing::Point(18, 3);
			this->dHr_23_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->dHr_23_0->Name = L"dHr_23_0";
			this->dHr_23_0->Size = System::Drawing::Size(34, 13);
			...
			this->dPanel_22_0->Location = System::Drawing::Point(1, 1057);
			...
			this->dPanel_22_0->Size = System::Drawing::Size(52, 47);
			...
			this->dHr_22_0->Location = System::Drawing::Point(18, 3);
			this->dHr_22_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->dHr_22_0->Name = L"dHr_22_0";
			this->dHr_22_0->Size = System::Drawing::Size(34, 13);
			...
			this->dPanel_21_0->Location = System::Drawing::Point(1, 1009);
			...
			this->dPanel_21_0->Size = System::Drawing::Size(52, 47);
			...
			this->dHr_21_0->Location = System::Drawing::Point(18, 3);
			this->dHr_21_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->dHr_21_0->Name = L"dHr_21_0";
			this->dHr_21_0->Size = System::Drawing::Size(34, 13);
			...
			this->dPanel_20_0->Location = System::Drawing::Point(1, 961);
			...
			this->dPanel_20_0->Size = System::Drawing::Size(52, 47);
			...
			this->dHr_20_0->Location = System::Drawing::Point(18, 3);
			this->dHr_20_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->dHr_20_0->Name = L"dHr_20_0";
			this->dHr_20_0->Size = System::Drawing::Size(34, 13);
			...
			this->dPanel_19_0->Location = System::Drawing::Point(1, 913);
			...
			this->dPanel_19_0->Size = System::Drawing::Size(52, 47);
			...
			this->dHr_19_0->Location = System::Drawing::Point(18, 3);
			this->dHr_19_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->dHr_19_0->Name = L"dHr_19_0";
			this->dHr_19_0->Size = System::Drawing::Size(34, 13);
			...
			this->dPanel_18_0->Location = System::Drawing::Point(1, 865);
			...
			this->dPanel_18_0->Size = System::Drawing::Size(52, 47);
			...
			this->dHr_18_0->Location = System::Drawing::Point(18, 3);
			this->dHr_18_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->dHr_18_0->Name = L"dHr_18_0";
			this->dHr_18_0->Size = System::Drawing::Size(34, 13);
			...
			this->dPanel_0_0->Size = System::Drawing::Size(52, 47);
			...
			this->dHr_0_0->Location = System::Drawing::Point(18, 3);
			this->dHr_0_0->Margin = System::Windows::Forms::Padding(2, 6, 2, 0);
			this->dHr_0_0->Name = L"dHr_0_0";
			this->dHr_0_0->Size = System::Drawing::Size(34, 13);
			...
			this->dPanel_0_1->Location = System::Drawing::Point(54, 1);
			...
			this->dPanel_0_1->Size = System::Drawing::Size(370, 1151);
			...
			this->display_week->Location = System::Drawing::Point(33, 10);
			this->display_week->Margin = System::Windows::Forms::Padding(2, 3, 2, 4);
			this->display_week->MaxLength = 7;
			this->display_week->Name = L"display_week";
			this->display_week->Size = System::Drawing::Size(73, 22);
			...
			this->info_layout->Location = System::Drawing::Point(611, 15);
			this->info_layout->Margin = System::Windows::Forms::Padding(2);
			...
			this->info_layout->Size = System::Drawing::Size(277, 36);
			...
			this->display_day->Location = System::Drawing::Point(2, 3);
			this->display_day->Margin = System::Windows::Forms::Padding(2, 3, 2, 4);
			this->display_day->MaxLength = 7;
			this->display_day->Name = L"display_day";
			this->display_day->Size = System::Drawing::Size(27, 29);
			...
			this->select_day_layout->Location = System::Drawing::Point(38, 26);
			...
			this->select_day_layout->Size = System::Drawing::Size(107, 23);
			...
			this->type_layout->Location = System::Drawing::Point(346, 26);
			...
			this->type_layout->Size = System::Drawing::Size(231, 23);
			this->type_layout->TabIndex = 17;
			// 
			// button6
			// 
			this->button6->Location = System::Drawing::Point(814, 639);
...
//			 Event_edit ^ F2 = gcnew Event_edit(activeYear, activeMonth,activeDay, activeHr, activeMin);
//			 F2->ShowDialog();
		 }
